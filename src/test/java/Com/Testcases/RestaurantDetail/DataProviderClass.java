...
public class DataProviderClass extends BaseTest {
	...
	@DataProvider(name = "Test_RestaurantDetail")
	public static Object[][] Test_RestaurantDetail() {

		return ExcelUtil.getTestData(xls, "Test_RestaurantDetail");
	}
	
	@DataProvider(name = "Test_LoadRestaurant")
	public static Object[][] Test_LoadRestaurant() {

		return ExcelUtil.getTestData(xls, "Test_LoadRestaurant");
	}
